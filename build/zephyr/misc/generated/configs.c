...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SAU_ANTENNA_ONBOARD, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SAU_AT_MAGPIO, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SAU_AT_COEX0, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SAU_ASSISTANCE_NONE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CLOUD_BACKEND, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CLOUD_MESSAGE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CLOUD_MESSAGE_PUBLICATION_INTERVAL, 10);
